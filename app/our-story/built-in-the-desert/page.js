    ...
    <>
      ...
      >
        <div className="container">
          <KineticText text="Built in the Desert. Not Imported In." Tag="h1" mode="word" staggerDelay={0.05} />
          ...
          <div style={{
            ...
            <ScrollReveal direction="up" once={true}>
              <div style={{display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px'}}>
                ...
                <div>
                  <NumberReveal number="40" label="Years at DVC" />
                </div>
              </div>
              <p className="prose" style={{fontSize: '18px', marginBottom: '16px'}}>
                Don, our longest-serving team member, has been at Desert Vision Center for nearly 40 years. Patients in their 80s and 90s still remember him. He remembers them.
              </p>
              <p className="prose" style={{fontSize: '18px'}}>
                That kind of institutional memory is rare. You cannot build it overnight. You cannot import it from somewhere else. It happens when people stay. When they invest in this place. When they care about the people who live here.
              </p>
            </ScrollReveal>
          </div>
        </div>
      ...
      <section className="section section-warm">
        <div className="container content-narrow">
          ...
          <FloatingQuote 
            quote="When you live in the same community as your patients, your reputation is your reputation. There is no distance between your work and your life."
            delay={0.2}
          />
        </div>
      </section>
