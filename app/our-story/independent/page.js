    ...
    <>
      ...
      >
        <div className="container">
          <ScrollReveal direction="up" once={true}>
            ...
            <h1><strong>Independent.</strong> Physician-Owned.</h1>
      ...
      <section className="section section-warm">
        <div className="container content-narrow">
          ...
          <BlurReveal><div className="pull-quote">
            <p>When I recommend a lens or treatment, it is because I think it is the right call. Not because someone told me to hit a number.</p>
          </div></BlurReveal>
        </div>
      </section>
      ...
      <section className="section section-warm">
        <div className="container content-narrow">
          ...
          <BlurReveal><div className="pull-quote">
            <p>I have the freedom to recommend what I actually think is right. Not what someone told me to recommend.</p>
          </div></BlurReveal>
        </div>
      </section>
