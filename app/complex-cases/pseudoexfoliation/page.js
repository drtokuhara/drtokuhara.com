...
export default function PseudoexfoliationPage() {
  return (
    <>
      ...
      <section className="section section-white">
        <div className="container content-narrow">
          ...
          <ul className="content-list">
            <li><strong>Modern chopping technique:</strong> I use a chopping technique that places significantly less stress on the zonules compared to the traditional "divide and conquer" method that most cataract surgeons still use today. This is one of the most important adaptations for pseudoexfoliation cases, because every force applied to the lens is transmitted through those weakened fibers.</li>
            <li><strong>Capsular tension rings (CTR):</strong> In select cases, I place a small, flexible ring inside the capsular bag to redistribute stress evenly and maintain long-term centration. I use these when the zonular weakness warrants it, though not every pseudoexfoliation case requires one.</li>
            <li><strong>Iris and capsule retractors:</strong> I use specialized hooks and retractors to support the capsule during surgery and pupil expanders to maintain working space when needed.</li>
            <li><strong>Segmental capsule rings with scleral fixation:</strong> For seriously damaged zonules, I use segmental rings that anchor to the sclera, providing targeted support exactly where the zonular loss is most significant.</li>
            <li><strong>Staged approach with vitreoretinal coordination:</strong> In the most serious cases where there is no remaining zonular support, I may coordinate with a vitreoretinal surgeon for a complete vitrectomy first, followed by secondary <Link href="/yamane-technique" style={{color: 'var(--night-horizon)'}}>Yamane technique lens implantation</Link>. This avoids the complications of placing a lens in an eye with no capsular support.</li>
          </ul>
          <p className="prose">
      ...
      <RelatedComplexCases current="pseudoexfoliation" />
