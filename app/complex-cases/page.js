      ...
      <section className="section section-warm">
        <div className="container">
          ...
          <StaggerChildren className="insights-grid" staggerDelay={0.06}>
            ...
            <TiltCard style={{position: 'relative', borderRadius: '16px'}}><Link href="/complex-cases/uveitis" className="insight-card insight-card-visual" style={{textDecoration: 'none', color: 'inherit'}}>
              <div className="insight-card-image"><Image src="/media/stock-family-golden-hour-walk.jpg" alt="Family walking together during golden hour" width={600} height={340} style={{width:'100%',height:'180px',objectFit:'cover',borderRadius:'16px 16px 0 0'}} /></div>
              <div className="insight-card-body"><span className="insight-cluster">Inflammatory</span><h2 className="insight-card-title">Uveitis</h2><p className="insight-card-desc">Inflammation changes everything about cataract surgery. Specialized timing, technique, and perioperative management for uveitic eyes.</p></div>
            </Link></TiltCard>
