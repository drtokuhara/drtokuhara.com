    ...
    <>
      ...
      <section style={{padding: 0}}>
        <div className="editorial-image-break">
          <Image src="/media/stock-couple-outdoor-sunshine.jpg" alt="Couple enjoying a sunny day outdoors - the confident, independent life that careful monocular surgery can restore" width={1920} height={400} style={{width: "100%", height: "auto"}} />
        </div>
      </section>
