...
export const metadata = {
  title: 'What Is the ORA System? The "Aura Machine" in Cataract Surgery - Dr. Keith Tokuhara',
  ...
  keywords: ['aura machine cataract surgery', 'intraoperative aberrometry', 'ORA system', 'cataract surgery technology', 'real-time lens measurement'],
  alternates: { canonical: '/insights/what-is-aura-machine' },
  openGraph: {
    title: 'What Is the ORA System? The "Aura Machine" in Cataract Surgery | Dr. Keith Tokuhara',
    ...
    url: 'https://drtokuhara.com/insights/what-is-aura-machine',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'What Is the ORA System? The "Aura Machine" in Cataract Surgery',
    description: 'Inside the ORA system (what patients call the Aura machine) and real-time lens measurements during surgery. When it helps, when it does not, and how judgment still matters most.',
  },
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The ORA system, also called the Aura machine, is a device that measures the refractive power of your eye during cataract surgery. It provides real-time feedback to help the surgeon confirm lens power selection and placement. It is an option, not a requirement, for most cataract surgeries.',
      },
    },
    {
      '@type': 'Question',
...
const jsonLd = [
  articleSchema({
    title: 'What Is the ORA System (Aura Machine)? How We Measure Your Vision During Surgery',
    ...
    slug: '/insights/what-is-aura-machine',
    datePublished: '2026-05-14',
  }),
  breadcrumbSchema([
    { name: 'Home', href: '/' },
    { name: 'Insights', href: '/insights' },
    { name: 'What Is the ORA System?', href: '/insights/what-is-aura-machine' },
  ]),
  faqSchema,
];

export default function InsightWhatIsAuraMachine() {
  return (
    <>
      {jsonLd.map((schema, i) => (
      ...
      <VideoBackground
        ...
        bottomOverlay={<AudioNarration src="/audio/narrations/what-is-aura-machine.mp3" />}
      >
        <div className="container">
          <ScrollReveal direction="up" once={true}>
          <span className="insight-hero-cluster">Tech Explainer</span>
          <h1>What Is the ORA System? <strong>The "Aura Machine" in Cataract Surgery</strong></h1>
