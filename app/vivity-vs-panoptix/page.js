    ...
    <>
      ...
      <section style={{padding: 0}}>
        <div className="editorial-image-break">
          <Image src="/media/stock-couple-golf-cart.png" alt="Active couple enjoying the Coachella Valley lifestyle with clear vision" width={1920} height={400} style={{width: '100%', height: '400px', objectFit: 'cover', objectPosition: 'center 30%'}} />
        </div>
      </section>
      ...
      <section style={{padding: 0}}>
        <div className="editorial-image-break">
          <Image src="/media/stock-seniors-outdoor-toast.jpg" alt="Seniors toasting outdoors in the Coachella Valley" width={1920} height={400} style={{width: '100%', height: '400px', objectFit: 'cover', objectPosition: 'center 30%'}} />
        </div>
      </section>
