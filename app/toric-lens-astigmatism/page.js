...
const pageBreadcrumbs = breadcrumbSchema([
  { name: 'Home', href: '/' },
  { name: 'Toric Lens for Astigmatism', href: '/toric-lens-astigmatism' },
]);
